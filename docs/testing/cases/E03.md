...
### TC_E03S01_03 — [RETIRED — contradicts Scenarios 3 and 4, where ownership moves only once the colleague accepts; superseded by TC_E03S01_07] Verify that the currently assigned Coordinator should be able to reassign the event to a colleague
...
### TC_E03S01_05 — Verify that when the named colleague declines a reassignment, the original Coordinator should remain assigned and be notified of the refusal

- **Sprint**: 2
- **AC reference**: E03-S01 - Scenario 5 (Reassignment declined)
- **Type**: 4 - Negative
