...
Rationale: the customer gave no numerical proximity thresholds (C-27, C-64).
E06-S02 (Sprint 3) already establishes suitability is advisory — an unsuitable
venue may still be requested. Inventing filter relaxation rules without customer
evidence would be an unjustified team assumption.
