...
As a system user, I want to update my name and contact details so that ConnectSphere reaches me at the correct address. Organisation is shown read-only per T-61; a shared organisation cannot be renamed or switched from the profile screen.
...
- Update name and contact details and see them persist
